    ...
    <section
      ...
      style={{
        background: background
          ? `linear-gradient(rgba(255, 255, 255, 0.05), rgba(255, 255, 255, 0.05)), url(${background})`
          : "none",
      ...
      <div className="w-full ">
        <div
          className={`w-full justify-start grid grid-cols-1 xl:grid-cols-2 gap-10 items-center ${
          ...
          <div className="w-full justify-center ">
            <Image
              width={500}
              height={504}
              className="w-full h-full sm:ml-0 ml-auto rounded-xl object-cover"
              src={image}
              alt="about Us image"
            />
          </div>
          <div
            ...
            <div className="w-full flex-col justify-center items-start gap-8 flex">
              <div className="w-full flex-col justify-start lg:items-start items-center gap-5 flex">
                ...
                <div className="lg:text-[18px]  font-medium text-[#343F43] mb-5  text-[18px] leading-[26px] tracking-[0.02em] align-middle opacity-100">
                  {description}
                </div>
              </div>
            </div>
            ...
            {counter && (
              <div className="flex items-center justify-center mt-4 space-x-3">
                {experience.map((exp, index) => (
                  <div
                    key={index}
                    className="flex flex-col justify-center items-center bg-[#F6F6F6] h-[126px] w-[100%] md:w-[150px] md:h-[192px] rounded-lg justify-self-center">
                    <div className=" justify-center ">
                      <h1 className="text-primary-2 xl:text-[24px] leading-9 text-primary ml-2">
                        {exp.Number}
                      </h1>
                    </div>
                    <p className="text-primary-2  mt-3 md:mt-6 text-center">
                      {exp.description}
                    </p>
                  </div>
                ))}
